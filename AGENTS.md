...
- Do not reintroduce rejected exact-calculation experiments such as stateful monotonic time masking, final-position-only logits projection, or static-cache SDPA prefix trimming unless new profiler evidence explains why the old negative result no longer applies.
