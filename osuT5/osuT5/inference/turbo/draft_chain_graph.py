...
class DraftChainGraphRunner:
    ...
    def replay_chain(
        ...
        *,
        ...
        """Replay γ-chain graph. Returns (tokens[γ], logits_after_γth_forward[V]).

        ``logits_after`` is the keep-KV next-cycle seed (formerly discarded tail).
        """
        ...
        return tokens, self._logits_ws.squeeze(0).clone()
