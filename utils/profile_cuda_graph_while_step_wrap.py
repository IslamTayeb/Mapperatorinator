...
from osuT5.osuT5.inference.optimized.single.while_child_graphs import (  # noqa: E402
    ChildGraphSequence,
...
def _tail_step(
    *,
    ...
    update_static_model_inputs(static_inputs, active)
    return active
...
def profile_real_prefix(
    ...
    *,
    ...
    report = {
        ...
        "metadata": {
            "result_class": "section32-while-step-wrap-gate",
        ...
        "decision": {
            "pass": passed,
            "next_gate": (
                "§32 rung 3 capture smoke + ≥0.15 ms/token budget before reciprocal"
                if passed
                else "STOP — do not open smoke/reciprocal"
            ),
        },
    }
