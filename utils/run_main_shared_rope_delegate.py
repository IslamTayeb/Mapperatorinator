...
def _enrich_initialization(path: Path, stats: SharedRopeStats, *, arm: str) -> None:
    try:
    ...
    payload["combined_runtime"] = SHARED_STAGE_COMPOSITION_VERSION
...
def run_with_main_shared_rope(
    ...
    *,
    ...
    try:
        ...
        stack.close()
    _enrich_initialization(output_init_json, main_stats, arm=arm)
