...
| Batch physics state/measurement gates | local / `6d115d4`, `854abd8` | request-order/private-RNG/active-row/EOS/slot-reuse tests plus exact observation/5% comparator; no CUDA execution claim. | Accepted verifier infrastructure. GPU merged B1/B2/B5 is the next gate; lanes remain blocked behind measured merged scaling. |
