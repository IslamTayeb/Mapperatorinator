...
- Relaxing exactness does not rescue the tested shared FP16/native-prefix shape on an RTX 2080 Ti. Current-main sentinel job `49715303` passed candidate self-repeat, cache ownership, finiteness, and RNG gates, but projected FP16 framework/native main times were `31.699s`/`32.213s` against the `25.419s` target. The current accepted SALVALAI work inventory is `7,684` main tokens, `28.243949s`, and 12 active-prefix buckets including `832`.
